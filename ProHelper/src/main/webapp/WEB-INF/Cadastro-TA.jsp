...
<body id="Cadastrar" >
	...
	<div id="main" class="MenuCadastro">
			<form accept-charset="UTF-8" action="/cadastrar-ta" method="POST">
				...
				<br>
				<input name="commit" type="submit" value="Cadastrar" onclick="return check()" />
			</form>
		</div>
	</div>
	...
	<script type="text/javascript">
		function check() {
			...
			else if(isNaN(document.getElementById('tipo').value)){
				alert("O campo \"Tipo\" deve ser um número que corresponde à sua função:\n\n1 - Técnico Administrativo\n2 - Professor");
				return false;
			}
			var i;
