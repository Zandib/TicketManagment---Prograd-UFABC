  ...
  <body>
    ...
    <div id="main" style="padding-top:50px;">
		...
		<table style="width:370px">
			<form accept-charset="UTF-8" action="/cadastrar-ta" method="POST"><div style="margin:0;padding:0;display:inline">
			<tr>
			...
			<tr>
		  	...
		  	<tr>
		 		<td>Tipo:</td><td>  <input id="tipo" name="tipo" type="text" /></td>
		  	</tr>
			<tr>
